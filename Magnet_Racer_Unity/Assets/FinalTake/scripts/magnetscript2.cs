...
public class magnetscript2 : manageforce
{
   ...
   // public GameObject repel8;
    ...
    {
        //Debug.Log("works");
        Color color = charge2 > 0 ? Color.green : Color.red;
    ...
    void FixedUpdate()
    {
        ...
        Vector3 newforce1 = direction1 * force1 * charge2 * polecharge * Time.smoothDeltaTime;
        ...
        Vector3 newforce2 = direction2 * force2 * charge2 * -polecharge * Time.smoothDeltaTime;
        ...
        Vector3 newforce3 = direction3 * force3 * charge2 * polecharge * Time.smoothDeltaTime;
        ...
        Vector3 newforce4 = direction4 * force4 * charge2 * -polecharge * Time.smoothDeltaTime;
        ...
        Vector3 newforce5 = direction5 * force5 * charge2 * charge1 * Time.smoothDeltaTime;
        ...
        Vector3 newforce6 = direction6 * force6 * charge2 * charge3 * Time.smoothDeltaTime;
        ...
        Vector3 newforce7 = direction7 * force7 * charge2 * charge4 * Time.smoothDeltaTime;
